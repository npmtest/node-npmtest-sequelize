...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-sequelize/node_modules/sequelize/lib/promise.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-sequelize/node_modules/sequelize/lib/promise.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-sequelize/node_modules/sequelize/lib/</a> &#187; promise.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >      if (Promise.Sequelize &amp;&amp; Promise.Sequelize.cls) {</span>
<span class="cstat-no" title="statement not covered" >        var ns = Promise.Sequelize.cls;</span>
<span class="cstat-no" title="statement not covered" >        for(var x=0; x&lt;fnArgs.length; x++) {</span>
<span class="cstat-no" title="statement not covered" >          var argIndex = fnArgs[x] &lt; 0 ? arguments.length + fnArgs[x] : fnArgs[x];</span>
<span class="cstat-no" title="statement not covered" >          if ( argIndex &lt; arguments.length &amp;&amp; typeof arguments[argIndex] === 'function' ) {</span>
<span class="cstat-no" title="statement not covered" >            arguments[argIndex] = ns.bind( arguments[argIndex] );</span>
          }
        }
      }
&nbsp;
